...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-white/80 backdrop-blur-xl border-b border-blue-200/50 shadow-sm">
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center space-x-3">
          {/* Notifications */}
          <button
            className="relative p-2 text-gray-600 hover:text-gray-800 hover:bg-blue-50 rounded-lg transition-colors"
            title="Thông báo"
          >
          ...
          {/* User Menu */}
          <div className="flex items-center space-x-3 bg-blue-50/50 rounded-lg px-3 py-2">
